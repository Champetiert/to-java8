...
public class DateAndTime_02_Test {
    ...
    public void test_localDate_format() {
        ...
        LocalDate localDate = LocalDate.parse("2015-03-11");
    ...
    public void test_with() {
        ...
        LocalDate result = localDate.with(ChronoField.DAY_OF_MONTH,05).with(ChronoField.MONTH_OF_YEAR,02).with(ChronoField.YEAR,2015);
